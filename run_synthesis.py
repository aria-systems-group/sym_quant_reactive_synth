...
if __name__ == "__main__":
    ...
    for run in range(ITERATIONS):
        ...
        setup_dict['weight_factor'] = WEIGHT_FACTOR
        ...
        if REGRET_GAME:
            ...
            if NO_PRIME:
                ...
                game = SymbolicPartitionedRegretDFAGameNoPrime(
                    ...
                    weight_factor=WEIGHT_FACTOR, budget=BUDGET, enable_reordering=ENABLE_REORDERING)
            else:
                ...
                game = SymbolicPartitionedRegretDFAGame(
                    ...
                    weight_factor=WEIGHT_FACTOR, only_reachable_states=ONLY_REACHABLE_STATES)
            setup_dict['goal'] = ''
        elif DFA_GAME:
            ...
            if NO_PRIME:
                ...
                game = SymbolicPartitionedDFAGameNoPrime(
                    ...
                    goal=GOAL, formula=FORMULA, restricted_human_locs=HUMAN_LOCS,
                    restricted_human_boxes=HUMAN_BOXES, ltlf_flag=LTLF_FLAG,
                    weight_factor=WEIGHT_FACTOR, enable_reordering=ENABLE_REORDERING)
            else:
            ...
            if NO_PRIME:
                ...
                game = FrankaWorldDynamicRatioTurnBasedElseNoPrime(
                    boxes=BOXES, locs=LOCS, ratio=RATIO, init=INIT,
                    goal=GOAL, restricted_human_locs=HUMAN_LOCS, weight_factor=WEIGHT_FACTOR,
