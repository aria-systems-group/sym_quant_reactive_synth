'''
 This file tests the Dynamic gridworld implementation. Specifically, it tests for the following:
 1. Compositional Construction of the Game Abstraction (yet to be implemented)
