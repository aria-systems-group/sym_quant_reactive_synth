...
from src.compositional_graphs.gridworld.gridworld_dynamic_dfa_game_no_prime import GridWorldDynamicDFAGameNoPrime


class GridWorldDynamicRegretGameNoPrime(GridWorldDynamicDFAGameNoPrime):
    """
     This class extends the GridWorldDynamicDFAGameNoPrime class to 
    ...
    def hybrid_gou_compute_preimage(self, win_state_bucket: Dict[int, BDD], return_bdd: bool = False) -> Union[ADD, Dict[int, BDD]]:
        ...
        for sval, succ_states in win_state_bucket.items():
            # first evolve over the DFA
            # dfa_preimage: BDD = succ_states.vectorCompose(self.bdd, list(self.dfa_handle.dfa_transition_relation_bdd.values()))
