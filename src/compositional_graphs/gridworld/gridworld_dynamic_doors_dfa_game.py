...
class GridWorldDynamicDoorsDFAGame(GridWorldDynamicDFAGame, GridWorldDynamicDoorsGame):
    ...
    def add_lbl_evolution_to_TR(self):
        ...
        game_prime_latch: List[ADD] = self.prime_tVars + self.prime_eVars + [var for prime_xVar_adds in self.prime_xVars for var in prime_xVar_adds] + [var for prime_yVar_adds in self.prime_yVars for var in prime_yVar_adds] + [var for prime_dVar_adds in self.prime_dVars for var in prime_dVar_adds]
